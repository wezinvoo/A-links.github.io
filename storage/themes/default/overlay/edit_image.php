...
<div class="row">
    ...
    <div class="col-md-4">
        <div class="position-sticky" id="main-overlay">
			<div class="custom-message custom-bg position-relative bottom-0 mx-0" style="background-color: <?php echo $overlay->data->bg ?>;background-image:url(<?php echo config('url').'/content/'.$overlay->data->bgimage ?>)">
				<div class="d-flex">
