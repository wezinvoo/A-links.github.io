...
class ComposerAutoloaderInit56084114163d04d8c993bdd8da3dc16f
{
    ...
    public static function getLoader()
    {
        ...
        if ($useStaticLoader) {
            $includeFiles = Composer\Autoload\ComposerStaticInit56084114163d04d8c993bdd8da3dc16f::$files;
        } else {
            $includeFiles = require __DIR__ . '/autoload_files.php';
        }
        foreach ($includeFiles as $fileIdentifier => $file) {
            composerRequire56084114163d04d8c993bdd8da3dc16f($fileIdentifier, $file);
        }
...
function composerRequire56084114163d04d8c993bdd8da3dc16f($fileIdentifier, $file)
{
